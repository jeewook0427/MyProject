...
{ // Visible health bar ui:
    ...
    [Tooltip("Health variable: (default range: 0-100)")] public float health = 10000;
    ...
    [Tooltip("Maximum possible heath: (default is 100)")] public float maximumHealth = 10000;

    // If the character has this health or less, consider them having low health:
    [Tooltip("Low health is less than or equal to this:")] public int lowHealth = 3300;
    ...
    [Tooltip("High health is greater than or equal to this:")] public int highHealth = 6700;
    ...
    private void Update()
    {
        healthPercentage = int.Parse((Mathf.Round(maximumHealth * (health / 10000f))).ToString());
