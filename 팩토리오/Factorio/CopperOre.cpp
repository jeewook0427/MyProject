...
int CopperOre::totalTileNum = 0;

HRESULT CopperOre::Init()
{

	return S_OK;
}

void CopperOre::Release()
{
}

void CopperOre::Update()
{
}

void CopperOre::Render(HDC hdc)
{
	if (Hp > 900)
	{
		frame = { 0,0 };
...
void CopperOre::SelectBoxRender(HDC hdc)
{
	if (!isSelectedClose)
	{
...
void CopperOre::InfoRender(HDC hdc)
{
