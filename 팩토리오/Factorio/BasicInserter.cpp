...
HRESULT BasicInserter::Init()
{
	return E_NOTIMPL;
}

void BasicInserter::Release()
{
}

void BasicInserter::Update()
{
...
void BasicInserter::Render(HDC hdc)
{
...
void BasicInserter::SelectBoxRender(HDC hdc)
{
	if (!isSelectedClose)
	{
...
BasicInserter::BasicInserter(TILE_POINT _tp, int hp)
{
	tp = _tp;
	Hp = hp;
	rect = { 32 * tp.x, 32 * tp.y, 32 * (tp.x + 1), 32 * (tp.y + 1) };

	image = ImageManager::GetSingleton()->FindImage("basic-inserter-platform");
	handBaseImage = ImageManager::GetSingleton()->FindImage("basic-inserter-hand-base");
	handClosedImage = ImageManager::GetSingleton()->FindImage("basic-inserter-hand-closed");
	handOpenImage = ImageManager::GetSingleton()->FindImage("basic-inserter-hand-open");
