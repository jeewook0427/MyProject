...
HRESULT IronGearWheel::Init(int x, int y)
{
	pos.x = x;
	pos.y = y;
	image = ImageManager::GetSingleton()->FindImage("iron-gear-wheel-icon");
	layer = IRONGEARWHEEL;
	isPicked = false;
...
void IronGearWheel::Release()
{
}

void IronGearWheel::Update()
{
	tp.x = (int)(pos.x / 32);
	tp.y = (int)(pos.y / 32);
...
void IronGearWheel::Render(HDC hdc)
{
...
void IronGearWheel::SelectBoxRender(HDC hdc)
{
}
