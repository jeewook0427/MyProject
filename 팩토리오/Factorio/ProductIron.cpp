...
HRESULT ProductIron::Init(int x, int y)
{
	pos.x = x;
	pos.y = y;
	image = ImageManager::GetSingleton()->FindImage("iron-icon");
	layer = IRON;
	isPicked = false;
...
void ProductIron::Release()
{
}

void ProductIron::Update()
{
	tp.x = (int)(pos.x / 32);
	tp.y = (int)(pos.y / 32);
...
void ProductIron::Render(HDC hdc)
{
...
void ProductIron::SelectBoxRender(HDC hdc)
{
}

ProductIron::ProductIron()
{
}
