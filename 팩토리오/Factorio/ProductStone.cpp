...
HRESULT ProductStone::Init(int x, int y)
{
	pos.x = x;
	pos.y = y;
	image = ImageManager::GetSingleton()->FindImage("stone-icon");
	layer = STONE;
	isPicked = false;
...
void ProductStone::Release()
{
}

void ProductStone::Update()
{
	tp.x = (int)(pos.x / 32);
	tp.y = (int)(pos.y / 32);
...
void ProductStone::Render(HDC hdc)
{
...
void ProductStone::SelectBoxRender(HDC hdc)
{
}
