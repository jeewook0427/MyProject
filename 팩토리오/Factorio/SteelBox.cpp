...
HRESULT SteelBox::Init()
{
	return S_OK;
}

void SteelBox::Release()
{

}

void SteelBox::Update()
{
...
void SteelBox::SelectBoxRender(HDC hdc)
{
	if (!isSelectedClose)
	{
...
void SteelBox::AddBox(Layer _name, int num)
{
	bool isExist = false;
