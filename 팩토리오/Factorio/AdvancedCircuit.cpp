...
HRESULT AdvancedCircuit::Init(int x, int y)
{
	pos.x = x;
	pos.y = y;
	image = ImageManager::GetSingleton()->FindImage("advanced-circuit-icon");
	layer = ADVANCEDCIRCUIT;
	isPicked = false;

	return S_OK;
}

void AdvancedCircuit::Release()
{
}

void AdvancedCircuit::Update()
{
	tp.x = (int)(pos.x / 32);
	tp.y = (int)(pos.y / 32);
...
void AdvancedCircuit::Render(HDC hdc)
{
...
void AdvancedCircuit::SelectBoxRender(HDC hdc)
{
}
